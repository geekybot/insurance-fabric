...
var logger = log4js.getLogger('APILogger');
...
log4js.configure({
	appenders: { Insurance: { type: 'dateFile', filename: 'insurance-log.log', pattern: '.yyyy-MM-dd', compress: true } },
	categories: { default: { appenders: ['Insurance'], level: 'debug' } }
...
//Routes for handling headersms requests
