...
###########################################
# user records
peer chaincode invoke -C insurancecommon -n insurance15 -c '{"args" :["registeruser","{\"userid\":\"1ab32c275ae\",\"mobileno\":\"9876543210\",\"name\":\"utpal pal\",\"email\":\"utpal@test.com\",\"dob\":\"05\/09\/1993\",\"gender\":\"Male\",\"nationality\":\"Indian\",\"address\":\"Bangalore\",\"insurances\":[],\"invoices\":[]}"]}' --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/insurance/orderers/orderer1.insurance/msp/tlscacerts/tlsca.insurance-cert.pem
peer chaincode invoke -C insurancecommon -n insurance15 -c '{"args" :["queryuser","{\"userid\":\"1ab32c275ae\"}"]}' --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/insurance/orderers/orderer1.insurance/msp/tlscacerts/tlsca.insurance-cert.pem
peer chaincode invoke -C insurancecommon -n insurance15 -c '{"args" :["updatebankdetails","{\"userid\":\"1ab32c275ae\",\"bank1\":\"HDFC, Bangalore, Account: 12545886\", \"bank2\":\"Deutche, Munich, Account: 65468651456\", \"dualAcc\": true}"]}' --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/insurance/orderers/orderer1.insurance/msp/tlscacerts/tlsca.insurance-cert.pem


# offers
peer chaincode invoke -C insurancecommon -n insurance15 -c '{"args" :["createoffer","{\"offerid\":\"5ab345875ae\",\"name\":\"Health Insurance Plus\",\"type\":\"Health Insurance\",\"termscondition\":\"lorem ipsum thingy\",\"baseprice\":2000}"]}' --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/insurance/orderers/orderer1.insurance/msp/tlscacerts/tlsca.insurance-cert.pem
peer chaincode invoke -C insurancecommon -n insurance15 -c '{"args" :["queryoffer","{\"offerid\":\"5ab345875ae\"}"]}' --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/insurance/orderers/orderer1.insurance/msp/tlscacerts/tlsca.insurance-cert.pem
peer chaincode invoke -C insurancecommon -n insurance15 -c '{"args" :["datapage","{\"sq\": {\"selector\": {\"obj\": \"Offer\",\"active\": true}},\"ps\": 10,\"bm\": \"\"}"]}' --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/insurance/orderers/orderer1.insurance/msp/tlscacerts/tlsca.insurance-cert.pem


# buyhealthinsurance

peer chaincode invoke -C insurancecommon -n insurance15 -c '{"args" :["buyhealthinsurance","{\"insuranceid\":\"ins12345\",\"userid\":\"1ab32c275ae\",\"name\":\"Utpal Pal\",\"gender\":\"Male\",\"email\":\"utpal@test.com\",\"mobileno\":\"9876543210\",\"city\":\"Bangalore\",\"age\":25,\"smoking\":true,\"dob\":\"05\/09\/1993\",\"occupation\":\"IT engineer\",\"height\":\"5ft 2 inch\",\"weight\":\"60kg\",\"healthremarks\":\"Nothing specific\",\"dualAcc\":true}"]}' --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/insurance/orderers/orderer1.insurance/msp/tlscacerts/tlsca.insurance-cert.pem
